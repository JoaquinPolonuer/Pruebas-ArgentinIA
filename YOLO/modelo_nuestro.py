...
def nuestro_detect(direc, pesos, size, save_img=False):
    view_img, save_txt, trace= False, False, True
    save_img = True
    source, weights, imgsz = direc, pesos, size
...
if __name__ == '__main__':
    source = 'DETECT/diario2.png'
    weights = 'DETECT/best.pt'
    img_size = 640

    nuestro_detect(source, weights, img_size)